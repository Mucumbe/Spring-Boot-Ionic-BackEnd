...
public class DBService {
	...
	Categoria cat4 = new Categoria(null, "Electronico");
	...
	Cliente cli1 = new Cliente(null, "Maria Silva", "mucumbeblandino@gmail.com", "36378912377",TipoCliente.PESSOAfISICA, pe.encode("123"));
	cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
	
	Cliente cli2 = new Cliente(null, "Ana Costa", "blandino@gmail.com", "31628382740",TipoCliente.PESSOAfISICA, pe.encode("123"));
	...
	Endereco e3 = new Endereco(null, "Av Floriano", "2106", null, "Centro", "281777012", cli2, c2);
	...
	Pedido ped2 = new Pedido(null, sdf.parse("10/10/2017 9:32"), cli1, e2);
